...
| `npm run test:security` | 0 | 2 files, 12/12 non-recursive RLS, lineage, normalized evidence-integrity, persistence-parity, and human-authority tests passed |
| `npm run test:recovery` | 0 | 1 file, 1/1 damaged-state recovery test passed |
| `npm run test` | 0 | 7 files, 82/82 tests passed |
