...
| GitHub branch/commit/PR | Pending until final commit, push, and PR receipt are appended |
| Hosted CI | UNKNOWN until a real run executes steps; billing-blocked or zero-step checks are not green proof |
